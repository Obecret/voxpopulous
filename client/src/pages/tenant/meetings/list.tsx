...
import type { Tenant, Meeting } from "@shared/schema";
...
export default function MeetingsList() {
  ...
  const { data: meetings, isLoading } = useQuery<MeetingWithRegistrations[]>({
    queryKey: ["/api/tenants", params.slug, "meetings"],
  });
        ...
        <CardContent className="p-6">
          <div className="flex flex-col lg:flex-row lg:items-start gap-4">
            ...
            <div className="lg:ml-4">
              <Link href={`/structures/${params.slug}/meetings/${meeting.id}`}>
                <Button 
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">
            Participez aux reunions, matchs, spectacles et autres evenements.
          </p>
        </div>
