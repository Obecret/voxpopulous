                ...
                <form onSubmit={editForm.handleSubmit((data) => {
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Titre</FormLabel>
                            <FormControl>
                              <Input placeholder="Ex: Concert de Noel" {...field} data-testid="edit-input-title" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Lieu</FormLabel>
                            <FormControl>
                              <Input placeholder="Ex: Salle des fetes" {...field} data-testid="edit-input-location" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                  ...
                  <DialogFooter className="flex-col sm:flex-row gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button type="submit" disabled={updateEventMutation.isPending} data-testid="edit-button-submit">
