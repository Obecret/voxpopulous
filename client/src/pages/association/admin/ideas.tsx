...
export default function AssociationAdminIdeas() {
  ...
  return (
    <AssociationAdminLayout association={association || null} user={user || null} tenantSlug={params.slug}>
      <div className="p-6">
        <div className="mb-6">
          <h1 className="font-display text-3xl font-bold" data-testid="text-assoc-ideas-title">
            Gestion des idees
          </h1>
          <p className="text-muted-foreground mt-1">Gerez les idees soumises a votre association.</p>
        </div>
          ...
          <CardHeader className="pb-4">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full md:w-40" data-testid="select-status-ideas">
              ...
              <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                <SelectTrigger className="w-full md:w-40" data-testid="select-category-ideas">
          ...
          <DialogContent className="max-w-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <Select value={newStatus} onValueChange={setNewStatus}>
                    <SelectTrigger data-testid="select-new-status-idea">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="NEW">Nouvelle</SelectItem>
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                data-testid="button-save-idea-status"
              >
